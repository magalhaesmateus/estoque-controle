...
Essa estrutura reflete o princípio de responsabilidade única: a camada model define os dados, enquanto a service concentra toda a lógica de manipulação do estoque.
 ...
 Funcionalidades
OperaçãoDescriçãoadicionarProdutoCadastra um novo produto no estoquelistarProdutosExibe todos os produtos cadastradosvenderProdutoReduz o estoque de um produto por ID e quantidaderemoverProdutoRemove um produto do estoque por ID
